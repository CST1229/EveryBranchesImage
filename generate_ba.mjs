...
const decompPath = "ba_decomp/";
const assetsPath = "ba_assets/";
...
<html lang="en">
	<head>
		...
		<link rel="icon" href="${assetsPath}assets/character/barfy/1.png"" />
		<title>Every Barfy's Adventure Image</title>
		<style>
			body {
				background: black;
				color: white;
...
await fs.writeFile("ba.html", html);
console.log("Written to ba.html.");